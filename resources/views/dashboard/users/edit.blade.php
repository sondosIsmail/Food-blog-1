...
@section('title') EditUser @endsection
@section('subheader')
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">EditUser</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">EditUserDetails</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Details-->
...
<div class="card-body p-0">
    <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
        <div class="col-xl-12 col-xxl-10">
            <!--begin::Wizard Form-->
            <form action="{{ route('users.update',$user->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data" id ="upload_form">
                @csrf
                @method('PUT')
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        ...
                        <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                            <h5 class="text-dark font-weight-bold mb-10">UserDetails</h5>
                            <!--begin::Group-->
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <div class="image-input image-input-outline" id="kt_user_add_avatar">
                                        <div class="image-input-wrapper" >
                                            <img id="avatar_upload" src="{{asset('uploads/'.$user->images->first()->name)}}" width="120" height="120">
